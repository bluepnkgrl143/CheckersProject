...
Building Instructions and Progress comments:
    ...
    Phase 2 Continue: Improving graphics, user interface, and implementing AI as an opponent.
        I wanted a graphic interface that would allow the user to play- click the game, and set up AI as an opponent.
